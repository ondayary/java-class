...
public class Names {
    ...
    public List<Student> getStudentObjs() {
        this.studentObjs.add(new Student(1,"남우빈","https://github.com/dongyeon-0822/java-project-exercise"));
        this.studentObjs.add(new Student(1,"최경민","https://github.com/kang-subin/Java"));
        this.studentObjs.add(new Student(3,"안준휘","https://github.com/KoKwanwun/LikeLion.git"));
        this.studentObjs.add(new Student(1,"하채민","https://github.com/lcomment/Algorithm_Solution--Java/tree/main/LikeLion"));
        this.studentObjs.add(new Student(2,"허도한","https://github.com/cmkxak/likelion-java-course"));
    ...
    public List<String> getNames() {
        ...
        // array는 갯수를 늘릴 수 없는데 List는 add 메소드를 이용해 계속 넣을 수 있다.
    }
}
